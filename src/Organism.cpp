...
void Organism::delta_concentration_compute()
{
  ...
  compute_delta_concentration(delta_concentration);

  compute_delta_protein_concentration(delta_concentration);
}
...
void Organism::compute_delta_concentration(std::map<float, float>& delta_concentration) {
...
void Organism::compute_delta_protein_concentration(std::map<float, float>& delta_concentration) {
